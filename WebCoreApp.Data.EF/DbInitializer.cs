    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            if (_context.Slides.Count() == 0)
            {
                ...
                {
                    new Slide() {Name="Slide 1",Image="/client-side/images/slider/slide1.jpg",Url="#",DisplayOrder = 0,GroupAlias = "top",Status = true },
                    new Slide() {Name="Slide 2",Image="/client-side/images/slider/slide2.jpg",Url="#",DisplayOrder = 1,GroupAlias = "top",Status = true },
                    new Slide() {Name="Slide 3",Image="/client-side/images/slider/slide3.jpg",Url="#",DisplayOrder = 2,GroupAlias = "top",Status = true },
